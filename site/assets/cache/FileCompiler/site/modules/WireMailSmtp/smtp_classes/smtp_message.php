...
<class>
	...
	<documentation>
		...
		<usage>This class should be used exactly the same way as the base
			...
			<tt> require(\ProcessWire\wire('files')->compile(\ProcessWire\wire("config")->paths->root . 'site/modules/WireMailSmtp/smtp_classes/email_message.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));<br />
 require(\ProcessWire\wire('files')->compile(\ProcessWire\wire("config")->paths->root . 'site/modules/WireMailSmtp/smtp_classes/smtp.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));<br />
 require(\ProcessWire\wire('files')->compile(\ProcessWire\wire("config")->paths->root . 'site/modules/WireMailSmtp/smtp_classes/smtp_message.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));<br />
			<br />
