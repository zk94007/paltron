...
class ProcessJumplinksConfig extends \ProcessWire\ModuleConfig
{
  /**
   * Documentation link
   * @const string
  ...
  {
    $field = \ProcessWire\wire('modules')->get($fieldNameId);
  ...
  public function getInputFields()
  {
    ...
    $fieldset->add($this->buildInputField('InputfieldRadios', [
      ...
      'skipLabel' => \ProcessWire\Inputfield::skipLabelHeader,
    ]));
    ...
    $fieldset = $this->buildInputField('InputfieldFieldset', [
      ...
      'collapsed' => \ProcessWire\Inputfield::collapsedNo,
      'skipLabel' => \ProcessWire\Inputfield::skipLabelHeader,
    ]);
