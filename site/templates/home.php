...
<main>
    ...
    <section class="job-classify-overview" id="job-classify">
        <h3 class="col-lg-4 col-md-6 col-sm-12"><?php echo __("Wir Unterstotzen Sie Beim Aufbau digitaler wettbewerbsvorteile"); ?></h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-11 col-sm-12 is-content">
                ...
                <div class="button-container">
                    <a href="" class="btn btn-primary" role="button"><?php echo __("Jobs anzeigen"); ?></a>
                    <a href="" class="btn btn-secondary" role="button"><?php echo __("Jetzt eintragen"); ?></a>
                </div>
            </div> 
        </div>
    </section>
    ...
    <?php
        if(!$data = $cache->get("faq", 5000)) {
            ...
            $data .= '</dl>';
            $data .= '<div class="button-container">';
            $data .= '<a href="" class="btn btn-primary multiline" role="button">'.htmlspecialchars_decode(__('Lassen Sie uns wissen, wie wir Sie<br>unterstützen können.')).'</a>';
            $data .= '</div> </div> </section>';
        }
        echo $data;
    ?>
    ...
    <?php
        if(!$data = $cache->get("expertise", 15000)) {
            $data .= '<section class="expertise" id="expertise">
                        <div class="container">';
            $data .= '<h1>'.__('Unsere Expertise').'</h1>';
