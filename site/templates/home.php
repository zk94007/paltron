...
<main>
    <?php
        ...
        if(!$data = $cache->get("home_top3", 5000)) {
            ...
            $data .= '<a href="#about" class="btn btn-primary" role="button">'. __("So finden wir Ihr Personal").'</a>';
            $data .= '</div> </div> </div> </div> </section>';
        }
        echo $data;
    ?>

    <?php include("./includes/featured_partner.inc"); ?>

    <section class="job-classify-overview" id="leistungen">
        <h3 class="col-lg-4 col-md-6 col-sm-12"><?php echo __("Wir unterstützen Sie beim Aufbau digitaler Wettbewerbsvorteile"); ?></h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-11 col-sm-12 is-content">
                ...
                <div class="button-container">
                    <a href="<?php echo $lang_url; ?>/job/find-job" class="btn btn-primary" role="button"><?php echo __("Jobs anzeigen"); ?></a>
                    <a href="https://paltron.kandidatenportal.eu/register/615" class="btn btn-secondary" role="button"><?php echo __("Jetzt eintragen"); ?></a>
                </div>
            </div> 
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="button-container">
                        <a href="#contact" class="btn btn-primary multiline" role="button"><?php echo htmlspecialchars_decode(__('In welchem Bereich benötigen<br> Sie Unterstützung?')); ?></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
    ...
    <?php include("./includes/testimonial.inc"); ?>
...
<!-- 
    ...
    <?php
        if(!$data = $cache->get("faq", 5000)) {
            ...
            $data .= '</dl>';
            $data .= '<div class="button-container">';
            $data .= '<a href="#contact" class="btn btn-primary multiline" role="button">'.htmlspecialchars_decode(__('Lassen Sie uns wissen, wie wir Sie<br>unterstützen können.')).'</a>';
            $data .= '</div> </div> </section>';
        }
        echo $data;
    ?>
    ...
    <?php
        if(!$data = $cache->get("expertise", 15000)) {
            $data .= '<section class="expertise" id="expertise">
                        <div class="container">';
            $data .= '<h2>'.__('Unsere Expertise').'</h2>';
