...
<main>
    <section class="job-overview-header" id="job-overview-header">
        ...
        <a href="https://paltron.kandidatenportal.eu/register/615?culture=<?php echo $lang_url; ?>" class="btn btn-primary" id="register_free"><?php echo __("JETZT KOSTENLOS REGISTRIEREN!"); ?></a>
    </section> 
    ...
    <section class="job_overview_note" id="job_overview_note">
        <div class="job_note_item">
            <div class="job_note_title">
                <a class="btn btn-link" href="<?php echo $lang_url; ?>/jobs/">
                    <h3>
        ...
        <div class="job_note_item">
            <div class="job_note_title">
                <a class="btn btn-link" href="https://paltron.kandidatenportal.eu/register/615?culture=<?php echo $lang_url; ?>">
                    <h3>
                        <ion-icon name='ios-arrow-dropright-circle'></ion-icon>
